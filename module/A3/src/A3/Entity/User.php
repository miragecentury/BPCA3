...
class User {
    ...
    /**
     * @ORM\OneToMany(targetEntity="A3\Entity\Personnage",mappedBy="User")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="A3\Entity\Side", inversedBy="Users")
     */
    protected $Side;

    /**
     * @ORM\ManyToOne(targetEntity="A3\Entity\Grade", inversedBy="Users")
     */
    protected $Grade;
